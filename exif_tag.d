...
alias typeof(EXIF_TAG_INTEROPERABILITY_INDEX) ExifTag;

/* GPS tags overlap with above ones. */
enum EXIF_TAG_GPS_VERSION_ID        = 0x0000;
enum EXIF_TAG_GPS_LATITUDE_REF      = 0x0001; /* INTEROPERABILITY_INDEX   */
enum EXIF_TAG_GPS_LATITUDE          = 0x0002; /* INTEROPERABILITY_VERSION */
enum EXIF_TAG_GPS_LONGITUDE_REF     = 0x0003;
enum EXIF_TAG_GPS_LONGITUDE         = 0x0004;
enum EXIF_TAG_GPS_ALTITUDE_REF      = 0x0005;
enum EXIF_TAG_GPS_ALTITUDE          = 0x0006;
enum EXIF_TAG_GPS_TIME_STAMP        = 0x0007;
enum EXIF_TAG_GPS_SATELLITES        = 0x0008;
enum EXIF_TAG_GPS_STATUS            = 0x0009;
enum EXIF_TAG_GPS_MEASURE_MODE      = 0x000a;
enum EXIF_TAG_GPS_DOP               = 0x000b;
enum EXIF_TAG_GPS_SPEED_REF         = 0x000c;
enum EXIF_TAG_GPS_SPEED             = 0x000d;
enum EXIF_TAG_GPS_TRACK_REF         = 0x000e;
enum EXIF_TAG_GPS_TRACK             = 0x000f;
enum EXIF_TAG_GPS_IMG_DIRECTION_REF = 0x0010;
enum EXIF_TAG_GPS_IMG_DIRECTION     = 0x0011;
enum EXIF_TAG_GPS_MAP_DATUM         = 0x0012;
enum EXIF_TAG_GPS_DEST_LATITUDE_REF = 0x0013;
enum EXIF_TAG_GPS_DEST_LATITUDE     = 0x0014;
enum EXIF_TAG_GPS_DEST_LONGITUDE_REF = 0x0015;
enum EXIF_TAG_GPS_DEST_LONGITUDE     = 0x0016;
enum EXIF_TAG_GPS_DEST_BEARING_REF   = 0x0017;
enum EXIF_TAG_GPS_DEST_BEARING       = 0x0018;
enum EXIF_TAG_GPS_DEST_DISTANCE_REF  = 0x0019;
enum EXIF_TAG_GPS_DEST_DISTANCE      = 0x001a;
enum EXIF_TAG_GPS_PROCESSING_METHOD  = 0x001b;
enum EXIF_TAG_GPS_AREA_INFORMATION   = 0x001c;
enum EXIF_TAG_GPS_DATE_STAMP         = 0x001d;
enum EXIF_TAG_GPS_DIFFERENTIAL       = 0x001e;
...
alias typeof(EXIF_SUPPORT_LEVEL_UNKNOWN) ExifSupportLevel;
...
/*! \internal */
ExifTag      exif_tag_table_get_tag  (uint n);

/*! \internal */
const (char)  *exif_tag_table_get_name (uint n);

/*! \internal */
uint exif_tag_table_count    ();


/* Don't use these definitions. They are here for compatibility only. */

/*! \deprecated Use EXIF_TAG_PRINT_IMAGE_MATCHING instead. */
enum EXIF_TAG_UNKNOWN_C4A5 = EXIF_TAG_PRINT_IMAGE_MATCHING;
