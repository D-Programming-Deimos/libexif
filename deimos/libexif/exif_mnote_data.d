 ...
 */
void exif_mnote_data_load (ExifMnoteData *d, const (ubyte) *buf,
			   uint buf_siz);
 ...
 */
void exif_mnote_data_save (ExifMnoteData *d, ubyte **buf,
			   uint *buf_siz);
 ...
 */
uint exif_mnote_data_count           (ExifMnoteData *d);
 ...
 */
uint exif_mnote_data_get_id          (ExifMnoteData *d, uint n);
 ...
 */
const (char)  *exif_mnote_data_get_name        (ExifMnoteData *d, uint n);
 ...
 * \return textual name of the tag
 */
const (char)  *exif_mnote_data_get_title       (ExifMnoteData *d, uint n);
 ...
 */
const (char)  *exif_mnote_data_get_description (ExifMnoteData *d, uint n);
 ...
 */
char  *exif_mnote_data_get_value (ExifMnoteData *d, uint n, char *val, uint maxlen);
